...
import { ArrowRight, ArrowUp, ChevronRight, Sparkles, Zap, Shield, Globe, Rocket, Eye } from "lucide-react";
...
const pageData = {
  features: [
    ...
    },
    {
      ...
      title: "সেলস বুস্ট",
      description: "কনভার্সন রেট বাড়ানোর জন্য ডিজাইন করা",
    },
    {
  ...
  processSteps: [
    {
      step: "০১",
      title: "কন্সাল্টেশন",
      description: "আপনার বিজনেস নিডস এবং গোলস নিয়ে ডিটেইল্ড ডিসকাশন",
    },
    {
      step: "০২",
...
const EcommerceSolution = () => {
  ...
  return (
    <div className="font-sans text-gray-800 bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/30 min-h-screen">
      ...
      {/* HERO SECTION */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-purple-900 via-pink-800 to-orange-900">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="group border-2 border-white/40 backdrop-blur-lg text-amber-500 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all hover:scale-105 active:scale-95">
      ...
      {/* FEATURES SECTION - 3 in a row for mobile */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {pageData.features.map((feature, i) => (
              <div
                key={i}
                className="group relative bg-gradient-to-br from-white to-gray-50 rounded-2xl p-4 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 aspect-square flex flex-col justify-center items-center border border-purple-100 shadow-sm"
              >
                ...
                <div className="relative z-10 text-purple-600 mb-3 flex justify-center group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
                
                <h3 className="relative z-10 text-sm font-bold text-gray-800 mb-2 group-hover:text-purple-600 transition-colors duration-300 leading-tight min-h-[3rem] flex items-center justify-center">
                  {formatTitle(feature.title)}
                </h3>
                
                <p className="relative z-10 text-xs text-gray-600 line-clamp-1 group-hover:text-gray-700 transition-colors duration-300 font-hind">
                  {feature.description}
                </p>
              </div>
            ))}
      ...
      {/* DEMO PROJECTS SECTION - 3 in a row for mobile */}
      <section className="py-12 md:py-20 bg-gradient-to-br from-gray-50 to-purple-50/30">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {pageData.demoProjects.map((project, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent text-white z-20">
                  ...
                  <p className="text-xs opacity-90 line-clamp-1 font-hind">
                    {project.description}
                  </p>
                </div>
      ...
      {/* PROCESS SECTION - 2 in a row for mobile, 4 for desktop */}
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-8 md:mb-12 leading-tight">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {pageData.processSteps.map((step, i) => (
              <div
                key={i}
                className="group relative bg-gradient-to-br from-white to-gray-50 rounded-2xl p-5 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 border border-purple-100 min-h-[200px] flex flex-col justify-center"
              >
                <div className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent mb-3">
                  {step.step}
                </div>
                
                <h3 className="text-lg font-bold text-gray-800 mb-3 leading-tight min-h-[3rem] flex items-center justify-center">
                  {formatTitle(step.title)}
                </h3>
                
                <p className="text-sm text-gray-600 line-clamp-2 font-hind">
                  {step.description}
                </p>
              </div>
            ))}
      ...
      {/* CLIENTS SECTION - Same as first design, 3 in a row for mobile */}
      <section className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-purple-50 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 relative z-10">
          <div className="text-center mb-8 md:mb-12">
            <span className="inline-block px-4 py-2 bg-white text-purple-600 rounded-full text-sm font-semibold mb-4 shadow-sm font-hind">
              বিশ্বস্ত ব্র্যান্ড
            </span>
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 md:gap-6">
            {pageData.clients.map((client, i) => (
              <div
                key={i}
                className="px-4 md:px-6 py-2 md:py-3 bg-white rounded-full shadow-md hover:shadow-lg transition-all border border-gray-100 hover:scale-105 active:scale-95"
              >
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-600 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-purple-100 text-lg mb-8 max-w-3xl mx-auto leading-relaxed font-hind">
