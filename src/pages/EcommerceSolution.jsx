    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="#demo"
                className="border-2 border-white px-8 py-4 rounded-full font-bold hover:bg-white hover:text-blue-600 transition"
              >
                ডেমো দেখুন
              </a>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-8 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory md:snap-none">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl shadow-lg hover:shadow-xl hover:bg-blue-100 transition transform hover:-translate-y-1 snap-center min-w-[260px] md:min-w-0 md:w-64 md:h-64 lg:w-72 lg:h-72 flex flex-col justify-center"
              >
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex md:grid md:grid-cols-3 gap-8 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory md:snap-none">
            {platforms.map((platform, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition border-2 border-gray-100 snap-center min-w-[260px] md:min-w-0 md:w-64 md:h-64 lg:w-72 lg:h-72 flex flex-col justify-center"
              >
            ...
            {packages.map((pkg, index) => (
              <div
                ...
                className={`rounded-2xl p-8 ${
                  pkg.popular
                    ? 'bg-gradient-to-br from-blue-500 to-indigo-600 text-white transform scale-105 shadow-2xl'
                    : 'bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg'
                } snap-center min-w-[260px] md:min-w-0 md:w-64 md:h-64 lg:w-72 lg:h-72 flex flex-col`}
              >
                {pkg.popular && (
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {pkg.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center gap-2">
                      <span className={pkg.popular ? 'text-yellow-300' : 'text-blue-500'}>✓</span>
