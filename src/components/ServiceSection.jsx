              ...
              <div className="relative z-10 space-y-4">
                ...
                >
                  {React.cloneElement(service.icon, {
                    className: "w-10 h-10 text-gray-700 group-hover:text-white transition-colors",
                  })}
                </div>
                ...
                <Link
                  to={
                    service.title === "রেস পেইজ সেটআপ"
                      ? "/brand-page-setup"
                      : service.title === "বিজনেস কনসালটিং"
                      ? "/business-consulting"
                      : "#"
                  }
                  className="flex items-center text-red-500 group-hover:text-white font-semibold pt-2"
                >
                  বিস্তারিত
